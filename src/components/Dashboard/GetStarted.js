    ...
    return (
        <div>
            <div className="mt-6 mx-auto text-md text-navy-900">
                Πρωτού ξεκινήσετε την συνεισφορά σας στο GreekQA, σας συστήνουμε να διαβάσετε τις <NavyLink className="text-md font-medium" to="/guidelines">Οδηγίες Χρήσης</NavyLink>.
            </div>
            <div className="my-8">
