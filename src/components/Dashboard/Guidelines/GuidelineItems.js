...
export const GuidelineItems = [
    {
        ...
        answer: <div className="text-md">Τα τελευταία χρόνια, o τομέας της <b>Επεξεργασίας Φυσικής Γλώσσας</b> έχει σημειώσει <b>αξιοσημείωτη πρόοδο</b> με την εντυπωσιακή εξέλιξη state-of-the-art μοντέλων.
                    <br/>
                    Μεταξύ των επιμέρους τομέων της Επεξεργασίας Φυσικής Γλώσσας, η <b>Αναγνωστική Κατανόηση</b> (Reading Comprehension) έχει σημειώσει αντίστοιχη σημαντική πρόοδο τα τελευταία χρόνια. 
                    <br/>
                    <br/>
                    ...
                    <br/>
                    <br/>
                    Στην παρούσα πλατφόρμα συλλογής δεδομένων <b>GreekQA</b>, εισάγουμε το <b>ομώνυμο Greek Question Answering Dataset (GreekQA)</b>, το <b>πρώτο</b> Ελληνικό Σύνολο Δεδομένων Ερωτήσεων και Απαντήσεων.
                    <br/>
                    Πιο συγκεκριμένα, το <b>GreekQA</b> στοχεύει να γίνει ένα ελληνικό σύνολο δεδομένων <b>κατανόησης ανάγνωσης εγγενών ερωτήσεων και απαντήσεων</b> σε ένα <b>σύνολο άρθρων της ελληνικής Wikipedia</b> που αποτελείται από 5.000+ δείγματα ερωτήσεων και απαντήσεων.</div>,
        open: "true"
    },
    {
    ...
    },
    {
        ...
        answer: <div>
                    Ιδανικά θέλουμε οι ερωτήσεις <b>να μη χρησιμοποιούν τις ίδιες λέξεις/φράσεις που εμφανίζονται στο κείμενο</b>.
                    <br/><br/>
                    ...
                    <ul className="pl-4 list-disc">
                        <li><b>Λεκτική παραλλαγή (συνωνυμία)</b>: Οι κύριες αντιστοιχίες μεταξύ της ερώτησης και της απάντησης είναι συνώνυμα.
                            ...
                            Παράδειγμα:
                            <ul className="pl-8">
                                <li>Ερώτηση: Πως <b>ονομάζεται</b> μερικές φορές ο κύκλος Rankine; </li>
