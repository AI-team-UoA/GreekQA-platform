...
export const GuidelineItems = [
    {
        ...
        answer: <div className="text-md">Τα τελευταία χρόνια, o τομέας της <b>Επεξεργασίας Φυσικής Γλώσσας</b> έχει σημειώσει <b>αξιοσημείωτη πρόοδο</b> με την εντυπωσιακή εξέλιξη state-of-the-art μοντέλων.
                    ...
                    <br/>
                    <br/>
                    Ωστόσο, η <b>πλειονότητα</b> των επιστημονικών εργασιών αυτού του τομέα <b>αφορούν την αγγλική γλώσσα</b>, καθώς τα <b>διαθέσιμα δεδομένα</b> που διατίθενται <b>σε άλλες γλώσσες</b>, όπως τα ελληνικά, είναι <b>περιορισμένα.</b>
                    <br/>
                    <br/>
