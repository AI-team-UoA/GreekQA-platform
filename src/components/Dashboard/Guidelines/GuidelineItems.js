...
export const GuidelineItems = [
    ...
    },
    {
        ...
        answer: <div className="space-y-4">
                    <p>
                        Για <b>οποιαδήποτε απορία</b>, μη διστάσετε να επικοινωνήσετε μαζί μας στη διεύθυνση <NavyLink a="true" className="font-bold" href="mailto:greekqa.di.uoa@gmail.com">greekqa.di.uoa@gmail.com</NavyLink>
                    </p>
                </div>,
        open: ""
    }
