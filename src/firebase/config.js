...
const firebaseErrors = {
  'auth/user-not-found': 'Η διεύθυνση email ή/και το συνθηματικό δεν είναι έγκυρα.',
  'auth/wrong-password': 'Η διεύθυνση email ή/και το συνθηματικό δεν είναι έγκυρα.',
  'auth/email-already-in-use': 'Υπάρχει ήδη λογαριασμός με αυτό το email.',
  'auth/weak-password:': 'Το συνθηματικό πρέπει να είναι τουλάχιστον 6 χαρακτήρες.',
  'auth/invalid-email': 'Η διεύθυνση email δεν είναι έγκυρη.',
  'auth/too-many-requests': 'Υπερβολικός αριθμός αιτημάτων. Παρακαλώ δοκιμάστε αργότερα.',
