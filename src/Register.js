    ...
    return (
        <div className="flex min-h-screen overflow-hidden">
            ...
            <div className="w-full max-w-xl mx-auto lg:w-96 bg-emerald-500">
                <div>
                    <h2 className="mt-6 text-3xl font-bold text-aqua-600 select-none">Εγγραφή στο GreekQA</h2>
                </div>
                <div className="mt-8">
                    <div className="mt-6">
                        <form onSubmit="" className="space-y-6">
                            <div>
                                <label htmlFor="text" className="block text-sm font-medium text-gray-700">Όνομα</label>
                                <div className="mt-1">
                            ...
                            <div>
                                <label htmlFor="text" className="block text-sm font-medium text-gray-700">Επώνυμο</label>
                                <div className="mt-1">
                        ...
                        <div className="relative flex justify-center text-sm text-aqua-800 hover:underline">
                            <Link to="/login">Είσοδος στην εφαρμογή (μόνο με email του ΕΚΠΑ)</Link>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div className="flex flex-col justify-center flex-1 px-4 py-12 relative flex-1 hidden w-0 overflow-hidden lg:block">
            ...
            <TypewriterSvg className="justify-content:center content-center w-3/5"/>
